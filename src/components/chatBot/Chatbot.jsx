    ...
    return <div className="chatbot">
        ...
        <div className="chatbot-blue">
            <div className="chat-info">
                ...
                <p className="download-description">Você também pode baixar meu currículo aqui se quiser dar uma olhada. Atualmente, estou procurando novas oportunidades, então se você tem um projeto que acha que eu seria uma boa opção, entre em contato!</p>
                <a href="https://drive.google.com/file/d/1Lin57jAzdqDK_PVDrr6jZeK1ltSouJ_G/view?usp=sharing" className="button">Download CV</a>
            </div>
