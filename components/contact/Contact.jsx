...
const Contact = () => {
    ...
    const sendEmail = (e) => {
        ...
        emailjs
          .sendForm('service_q6m4yyk', 'template_ov1c5iv', formRef.current, {
            publicKey: 'Q3MnvIZINe6pIW1uo',
          })
          .then(
            () => {
              setSuccess(true)
    ...
    return (
        ...
        >
            ...
            <div className={style['form-container']}>
                <motion.div
                    className={style['phone-svg']}
                    initial={{ opacity: 1 }}
                    whileInView={{ opacity: 0 }}
                    transition={{ delay: 3, duration: 1 }}
                >
                    <svg width="100%" height="450px" viewBox="0 0 32.666 32.666">
                        <motion.path
                            strokeWidth={0.2}
                            fill="none"
